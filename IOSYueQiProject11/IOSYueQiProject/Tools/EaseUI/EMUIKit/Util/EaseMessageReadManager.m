...
- (void)showBrowserWithImages:(NSArray *)imageArray viewcontroller:(UIViewController *)view
{
    ...
    [view presentViewController:self.photoNavigationController animated:YES completion:nil];
}
