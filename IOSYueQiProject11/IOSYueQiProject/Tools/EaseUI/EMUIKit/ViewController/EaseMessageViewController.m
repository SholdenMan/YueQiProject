...
- (void)viewDidLoad {
    ...
    [[EaseBaseMessageCell appearance] setSendBubbleBackgroundImage:[[UIImage imageNamed:@"IMright"] stretchableImageWithLeftCapWidth:5 topCapHeight:35]];
    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"IMleft"] stretchableImageWithLeftCapWidth:35 topCapHeight:35]];
    ...
    self.tableView.backgroundColor = Color(240, 240, 240);
        ...
        if (imageBody.thumbnailDownloadStatus == EMDownloadStatusSuccessed) {
            if (imageBody.downloadStatus == EMDownloadStatusSuccessed)
            {
                ...
                if (localPath && localPath.length > 0) {
                    ...
                    if (image)
                    {
                        [[EaseMessageReadManager defaultManager] showBrowserWithImages:@[image] viewcontroller:self];
                    }
                    else
                    {
