...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"IMphoto"] forState:UIControlStateNormal];
    [_photoButton setImage:[UIImage imageNamed:@"IMphoto"] forState:UIControlStateHighlighted];
    ...
    [_locationButton setImage:[UIImage imageNamed:@"IMdingwei"] forState:UIControlStateNormal];
    [_locationButton setImage:[UIImage imageNamed:@"IMdingwei"] forState:UIControlStateHighlighted];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"IMxiangji"] forState:UIControlStateNormal];
    [_takePicButton setImage:[UIImage imageNamed:@"IMxiangji"] forState:UIControlStateHighlighted];
