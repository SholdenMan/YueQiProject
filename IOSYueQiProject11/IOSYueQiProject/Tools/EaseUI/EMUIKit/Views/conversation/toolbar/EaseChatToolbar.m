...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"icon-keyboardss"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"IMbiaoqing"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"IMbiaoqing"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"icon-keyboardss"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"IMadd"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"IMadd"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"icon-keyboardss"] forState:UIControlStateSelected];
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text
{
    if ([text isEqualToString:@"\n"]) {
        if ([self.delegate respondsToSelector:@selector(didSendText:)]) {
            ...
            NSDictionary *ext = @{@"nickname":[userDef objectForKey:@"nickname"],
                                  @"avatarURLPath":[userDef objectForKey:@"usericon"],
                                  @"USERNAME":[userDef objectForKey:@"userName"],
                                 };
